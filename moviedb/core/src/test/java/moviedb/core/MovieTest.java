...
public class MovieTest {
    ...
    public void testThresholdValues() {
        assertThrows(IllegalArgumentException.class, () -> {
            Movie movie = new Movie("Test", -1, List.of("Genre"), 100, 5.0);
        }, "Constructor should not allow negative values for release year");
        assertThrows(IllegalArgumentException.class, () -> {
            Movie movie = new Movie("Test", 1990, List.of("Genre"), 0, 5.0);
        }, "Constructor should not allow a runtime of zero");
        assertThrows(IllegalArgumentException.class, () -> {
            Movie movie = new Movie("Test", 1990, List.of("Genre"), -1, 5.0);
        }, "Constructor should not allow negative runtime");
        assertThrows(IllegalArgumentException.class, () -> {
            Movie movie = new Movie("Test", 1990, List.of("Genre"), 100, 0.3);
        }, "Constructor should not allow ratings less than 1.0");
        assertThrows(IllegalArgumentException.class, () -> {
            Movie movie = new Movie("Test", 1990, List.of("Genre"), -1, 10.1);
    ...
    public void testToString() {
        ...
        assertEquals("Name: Test - Release year: 1990 - Genre(s): Genre - Runtime: 100 - Rating: 5.0", movie.toString());
        assertEquals("Name: Test2 - Release year: 1990 - Genre(s): Genre, Genre2, Genre3 - Runtime: 100 - Rating: 5.0", movie2.toString());
    }
