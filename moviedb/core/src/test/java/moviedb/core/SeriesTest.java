...
public class SeriesTest {
    ...
    public void testThresholdValues() {
        assertThrows(IllegalArgumentException.class, () -> {
            Series series = new Series("Test", -1, List.of("Genre"), 10, 5.0);
        }, "Constructor should not allow negative values for release year");
        assertThrows(IllegalArgumentException.class, () -> {
            Series series = new Series("Test", 1990, List.of("Genre"), 0, 5.0);
        }, "Constructor should not allow number of seasons as zero");
        assertThrows(IllegalArgumentException.class, () -> {
            Series series = new Series("Test", 1990, List.of("Genre"), -1, 5.0);
        }, "Constructor should not allow negative number of seasons");
        assertThrows(IllegalArgumentException.class, () -> {
            Series series = new Series("Test", 1990, List.of("Genre"), 10, 0.3);
        }, "Constructor should not allow ratings less than 1.0");
        assertThrows(IllegalArgumentException.class, () -> {
            Series series = new Series("Test", 1990, List.of("Genre"), -1, 10.1);
    ...
    public void testToString() {
        ...
        assertEquals("Name: Test - Release year: 1990 - Genre(s): Genre - Seasons: 10 - Rating: 5.0", series.toString());
        assertEquals("Name: Test2 - Release year: 1990 - Genre(s): Genre, Genre2, Genre3 - Seasons: 10 - Rating: 5.0", series2.toString());
    }
