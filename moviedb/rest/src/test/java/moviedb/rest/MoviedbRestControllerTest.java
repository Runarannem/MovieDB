...
@ContextConfiguration(classes = {MoviedbRestController.class, MovieDatabaseRepository.class, SeriesDatabaseRepository.class, MoviedbServerApplication.class})
@WebMvcTest
public class MoviedbRestControllerTest {
    ...
    public void testGetMovies() throws Exception {
        MvcResult result = mockMvc.perform(MockMvcRequestBuilders.get(MOVIES_PATH))
                ...
                .andReturn();
        try {
            MovieDatabase movieDatabase= movieObjectMapper.readValue(result.getResponse().getContentAsString(), MovieDatabase.class);
    ...
    public void testGetSeries() throws Exception {
        MvcResult result = mockMvc.perform(MockMvcRequestBuilders.get(SERIES_PATH))
                ...
                .andReturn();
        try {
            SeriesDatabase seriesDatabase= seriesObjectMapper.readValue(result.getResponse().getContentAsString(), SeriesDatabase.class);
