...
public class MenuControllerTest extends ApplicationTest {
    ...
    /**
     * Gets all movies and series from files, clears savefiles in case items were added before tests were run to prevent conflicts
     */
    @BeforeEach
    ...
    // NB! clickOn-method does not support fx-ids with spaces in them, thus testing is somewhat limited
    @Test
    public void testAddAndRemove() {
        ...
        // Add movie with defaultImage:
        String s = getClass().getResource("images/defaultImage.png").toString();
        s = s.substring(6);
        this.menuController.setPrevImage(new Image(s));
        addMedia("MovieWithImage", "2022", "5.5", "130", false);
        clickOn("#movieTab");
        Button button3 = (Button) this.menuController.getGridPane(false).getChildren().get(0);
        assertEquals("Test_1999_90_movie", button3.getId().toString());
        ...
        // Add series with image:
        // As a FileChooser cannot be operated with testFX, the handleImage() method cannot be tested.
        // Instead directly set image to use defaultImage.png.
        this.menuController.setPrevImage(new Image(s));

        addMedia("SeriesWithImage", "2022", "6.0", "3", true);
        clickOn("#seriesTab");
        ...
        assertDoesNotThrow(() -> {
            ...
            clickOn("#deleteButton");
            errorPopup();
            clickOn("#SeriesWithImage_2022_3_series");
            clickOn("#deleteButton");
            errorPopup();
        });
        ...
        assertDoesNotThrow(() -> {
            ...
            clickOn("#deleteButton");
            errorPopup();
            clickOn("#MovieWithImage_2022_130_movie");
            clickOn("#deleteButton");
            errorPopup();
        });
    }
